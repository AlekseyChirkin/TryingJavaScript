...
fs.readFile('tasks/textsForTasks/names.txt', 'utf8', (err, data) => {
    ...
    namesArray.forEach(element => {
        content += element.slice(0, -1) + ' ' + Math.round(Math.random() * 30 + 1980) + ' ' + Math.round(Math.random() * 4 + 1) + ' ' + Math.round(Math.random() * 6 + 1) + ' ' + Math.round(Math.random() * 3 + 2) + ' ' + Math.round(Math.random() * 3 + 2) + ' ' + Math.round(Math.random() * 3 + 2) + ' ' + Math.round(Math.random() * 3 + 2) + ' ' + Math.round(Math.random() * 3 + 2) + '\n';
    });
